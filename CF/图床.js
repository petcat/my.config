...
<head>
	...
	<meta name="keywords" content="多合一图床,Cdn图床,百度图床,阿里图床,京东图床,搜狗图床,搜狐图床,QQ图床,XKX图床,58图床,头条图床,网易图床,360图床,葫芦侠图床" />
...
<body>
	...
	<div class="container">
		<div class="upload">
			<div class="title">开始上传<!--input id="xkx" autocomplete="off" maxlength="16" placeholder="请输入上传..."-->
	...
	<div id="footer" style="position:fixed;width: 100%;text-align: center;bottom: 0px;display: block;">
		...
		© 
		<a style="text-decoration:none;" href="https://api.xkx.me/">xKx.Me | </a>更多：<a style="text-decoration:none;" href="https://api.xkx.me/">短视频解析</a>
		</p>
		</div>
		</div>
</body>
