...
alias caddystop='systemctl stop caddy'
alias caddystart='systemctl start caddy'
alias caddystatus='systemctl status caddy'
alias icaddy='systemctl status caddy'
alias caddy2='mcedit /etc/caddy/Caddyfile'
alias caddyfiles='nano -w -m /etc/caddy/Caddyfile'
# caddy 1.x
...
alias aira2c='aria2c'
alias p2p='aria2c'
alias aria2c-start='systemctl start aria2c.service'
alias aria2c-stop='systemctl stop aria2c.service'
alias iaria2c='systemctl status aria2c.service'
alias myaria2c='systemctl status aria2c.service'
alias rearia2c='systemctl restart aria2c.service'
